...
class FPENet(nn.Module):
    def __init__(self, in_channels,classes=19, zero_init_residual=False,
        ...
        self.conv1 = nn.Conv2d(in_channels, outplanes[0], kernel_size=3, stride=2, padding=1,bias=False)
